...
export default function MainTextHome() {
  ...
  return (
    <motion.div
      ...
      className="relative mx-20 mt-4 flex w-full items-center justify-center min-[300px]:flex-col min-[645px]:flex-col xl:flex-col xl:gap-8"
    >
      <svg
      ...
      >
        ...
        <h1 className="descript_text_home text-[#a1a1a1] xl:w-[522px] xl:text-center xl:text-[1rem]">
