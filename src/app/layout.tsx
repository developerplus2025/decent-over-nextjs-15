              ...
              <Toaster
                ...
                toastOptions={{
                  ...
                  classNames: {
                    ...
                    closeButton:
                      "dark:bg-black  !left-[325px] !transform-[translate(0%,50%)] !top-1/2 !border-[#4c4c4c] !-translate-y-1/2 border border-[#404040] transition-[background] transition-colors  ease-out duration-500 bg-white hover:bg-muted dark:hover:bg-white dark:hover:text-black",
                  },
                }}
                offset={{ top: "5rem" }}
                closeButton
