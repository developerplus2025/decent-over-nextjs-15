...
export function DocsSidebar({
          ...
          children: [
            {
              ...
              name: "Installation",
              description:
                "Learn how to install the music software on your system and ensure everything is set up correctly.",
              url: "/docs/docs",
              $ref: {
            ...
            },
            {
              ...
              description:
                "Get to know the main sections of the music software interface and how they work.",
            ...
            },
            {
              ...
              description:
                "Learn how to import audio files into the music software and manage your music library.",
            ...
            },
            {
              ...
              name: "First Play",
              description:
                "Learn how to start your first playback and explore basic controls of the music software.",
          ...
          children: [
            {
              ...
              name: "Playlists",
              description:
                "Learn how to create, manage, and customize playlists in your music library.",
            ...
            },
            {
              ...
              description:
                "Learn how to loop tracks or enable shuffle playback in your music experience.",
            ...
            },
            {
              ...
              name: "Playback Speed",
              description:
                "Adjust the speed of music playback without affecting pitch.",
          ...
          children: [
            {
              ...
              name: "Equalizer",
              description:
                "Learn how to shape your sound using the built-in equalizer.",
            ...
            },
            {
              ...
              name: "Reverb & Delay",
              description:
                "Add spatial effects to enhance your music experience.",
          ...
          children: [
            {
              ...
              description:
                "Learn how to organize your music library efficiently.",
            ...
            },
            {
              ...
              name: "Tag Editing",
              description:
                "Edit song metadata like title, artist, genre, and album art.",
            ...
            },
            {
              ...
              description:
                "Automatically create playlists based on rules and filters.",
          ...
          children: [
            {
              ...
              name: "Themes",
              description:
                "Change the look and feel of the software with themes.",
            ...
            },
            {
              ...
              name: "Audio Devices",
              description:
                "Manage input and output devices for the best sound experience.",
            ...
            },
            {
              ...
              description:
                "Use custom hotkeys for quicker navigation and control.",
          ...
          children: [
            {
              ...
              description:
                "Connect and control your software with MIDI devices.",
            ...
            },
            {
              ...
              name: "Plugin Support",
              description:
                "Extend functionality using audio plugins (VST, AU).",
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              name: "App Crashes",
              description:
                "Fixes and tips when the software crashes unexpectedly.",
            ...
            },
            {
              ...
              description:
                "Tips for resolving lag, slow playback, or high CPU usage.",
  ...
  return (
    ...
    >
      <SidebarHeader>
        <VersionSwitcher
          ModeGuided={data.versions}
          defaultModeGuided={"Docs"}
        />
      </SidebarHeader>
